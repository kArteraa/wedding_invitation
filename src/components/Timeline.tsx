                    ...
                    <div className="timeline__wrapper__block">
                        ...
                        <div className="timeline__wrapper__block__content">
                            ...
                            <ScrollAnimation direction={"left"} delay={0.4}>
                                <p className="timeline__wrapper__block__content__description">Время регистрации: 10:00 <br/> Приходим по желанию! <br />(В случае, если вы собираетесь придти, то просим подойти заранее за 15 минут!)</p>
                            </ScrollAnimation>
                        </div>
                    </div>
                    <div className="timeline__wrapper__block">
